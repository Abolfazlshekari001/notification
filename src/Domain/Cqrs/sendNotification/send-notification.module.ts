...
import { sendForMultipleDeviceCommandHandler } from './SendMultipleForDevice/SendMultipleForDevice.command-handler';
import { DeviceEntity } from 'src/Domain/Entities/Registered-Devices.entity';
import { SendDataCommandHandler } from './SendDataForNotification/SendData.command-handler';
export const CommandHandlers = [
  sendForOnePersonCommandHandler,
  SendToMultipleTopicsCommandHandler,
  sendForMultipleDeviceCommandHandler,
  SendDataCommandHandler,
];
...
@Module({
  imports: [
    ...
    TypeOrmModule.forFeature([System, topicsEntity, DeviceEntity]),
    CqrsModule,
  ],
