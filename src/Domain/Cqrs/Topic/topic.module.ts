...
import { GetAllTopicQueryHandler } from './queries/GetAllTopic/getAllTopic.command-handler';
...
import { GetAllSubForTopicQueryHandler } from './queries/GetAllSubForOneTopic/getAllSubForOneTopic.command';
