...
import { Unauthorized, Double_comment, TheDataHasAlreadyBeenDeleted, DataNotFound, Data_Field_Is_Duplicate, forbiddenResource, Bad_Request_Exception, Total_Resend_Code, NoContent, Invalid_Input, DataNotFound2, PageNotFound, InternalServerError } from "../translate/Error.Translate";
import { Request_Was_Successful, Request_Was_Successful2, Request_Was_Successful1, Request_Was_Successful3, Request_Was_Successful4 } from "../translate/Successful.Translate";
