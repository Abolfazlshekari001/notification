...
export const Token_Is_Subescribed = {
  status_code: 422,
  code: 1020,
  message: {
    fa: 'توکن از قبل در این تاپیک مشترک شده',
    en: 'The token has already been subscribed to this thread',
  },
};

export const Token_Is_UnSubescribed = {
  status_code: 422,
  code: 1020,
  message: {
    fa: 'این توکن قبلاً لغو اشتراک در این  تاپیک شده است',
    en: 'The token has already been unSubscribed to this thread',
  },
};
...
export const Token_Already_Exists = {
  ...
  code: 1021,
  message: {
      fa: "این توکن قبلاً وجود دارد",
      en: "The token already exists",
  },
};